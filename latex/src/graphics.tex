...
surf boundary/.style={draw=black!70},
surf boundary soft/.style={draw=gray},
surf boundary dashed/.style={draw=gray,dashed},
}
...
\tikzset{
cmove setting one disk/.pic={\pic {surf circle={d#1}{1.5}};\tikzset{exec on layer={surf base}{\fill[disk #1] \surfcirclepath{d#1}{0}{360};},exec on layer={surf edge behind}{\path[surf boundary] \surfcirclepath{d#1}{0}{360};}}},
