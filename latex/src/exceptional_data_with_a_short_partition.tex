...
\begin{itemize}
\item Assume that the inequality $v(\pi_i)+v(\pi_j)<d$ holds for a pair of indices $1\le i<j\le n-1$; up to reindexing, we can assume that $v(\pi_1)+v(\pi_2)<d$. \Cref{monodromy:th:product-reduction-small-v} gives permutations $\alpha_1,\alpha_2\in\symgroup[d]$ with $[\alpha_1]=\pi_1$ and $[\alpha_2]=\pi_2$ such that $v(\alpha_1\alpha_2)=v(\alpha_1\alpha_2)$. By induction the candidate datum
\[
