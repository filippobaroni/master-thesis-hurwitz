...
\begin{theorem}
Let $\DD=\datum{\tSigma,\Sigma}{d}{\pi_1,\ldots,\pi_n}$ be a candidate datum with $\Sigma$ and $\tSigma$ both orientable or both non-orientable. If $\chi(\Sigma)\le 0$, then $\DD$ is realizable.
\end{theorem}

\begin{proposition}
Let $\DD=\datum{\tSigma,\Sigma}{d}{\pi_1,\ldots,\pi_n}$ be a candidate datum with $\Sigma$ non-orientable and $\tSigma$ orientable. If $\chi(\Sigma)\le 0$, then $\DD$ is realizable.
\end{proposition}
...
\]
or, in other words, $\beta=\cycle{1,2}\beta'$; moreover, as explained in \cref{monodromy:rm:product-reduction-odd-prescribed-cycles}, we can choose $\alpha'$ in such a way that $2$ belongs to its $(a_1-1)$\=/cycle. By setting $\alpha=\alpha'\cycle{1,2}$, we immediately get that $\alpha\beta=\alpha'\beta'$ is a $(d-1)$\=/cycle fixing $1$. Finally, the action of $\angled{\alpha,\beta}$ is transitive since $\alpha$ does not fix $1$.
\end{proof}
