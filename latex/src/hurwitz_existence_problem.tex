...
Orientable and non-orientable surfaces are completely classified by a well-known structure theorem (see \resultcite{theorem}{12.1}{munkres}).
\begin{itemize}
